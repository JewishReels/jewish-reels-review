...
const allowed = new Set(['bootstrap','choose-project','reopen-project','refresh-project','get-models','save-key','forget-key','start-review','set-dispatch-mode','pause-review','hit-recheck-info','hit-recheck-results','start-hit-recheck','pause-hit-recheck','clear-hit-recheck','open-hit-recheck-report','image','match-image','result-detail','open-project-folder','open-review-logs','open-url','export','create-workspace','import-source','crawl-website','set-active-source','start-preparation','pause-preparation','set-auto-backfill','retry-preparation','sync-verdicts','cleanup-media','preview-prepared','get-criteria','save-criteria','reset-criteria']);
