...
Verified official Vimeo matches are stored in the queue. If a download pauses for missing Vimeo access, saving access resumes from that verified URL instead of repeating the catalog search.
