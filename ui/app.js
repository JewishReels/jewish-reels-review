...
function renderPreparation(s){
  ...
  $('diskMetric').textContent=bytesLabel(s.footageBytes||0);$('reclaimedNote').textContent=`Saved cards: ${bytesLabel(s.cardBytes||0)} · reclaimed: ${bytesLabel(s.reclaimed||0)}`;
