...
function renderPreparation(s){
  ...
  for(const id of ['scrapflyApiKey','rememberScrapflyKey','saveScrapflyKey','forgetScrapflyKey','vimeoAccessMode','vimeoProfile','chooseVimeoCookies','saveVimeoAccess'])$(id).disabled=['running','buffered','pausing','crawling'].includes(s.status);
